// VO: DisplayName (User - local)
#nullable enable
using System.Text.RegularExpressions;
using Yina.Common.Abstractions.Errors;
using Yina.Common.Abstractions.Results;

namespace YinaCRM.Core.Entities.User.VOs;
...
{
    public static Error Empty() => Error.Create("USER_DISPLAYNAME_EMPTY", "Display name is required", 400);
    public static Error Invalid() => Error.Create("USER_DISPLAYNAME_INVALID", "Display name must be 1–100 chars (letters/digits/space . , ' -)", 400);
}
